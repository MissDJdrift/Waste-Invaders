...
public sealed class GameManager : MonoBehaviour
{
    ...
    public void IncorrectPopUpMessage(Enemy enemy)
    {
        ...
        if (Stage == 1)
        {
            ...
            {
                message = "This object is a Type 1 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 2)
            {
                message = "This object is a Type 2 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 3)
            {
                message = "This object is a Type 3 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 4)
            {
                message = "This object is a Type 4 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 5)
            {
                message = "This object is a Type 5 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 6)
            {
                message = "In Quebec, Type 6 plastic goes in the trash! So make sure you categorize it as trash!";
            }
            else if (enemy.Stage1EnemyType[0] == 7)
            {
                message = "This object is a Type 7 Plastic! Be careful!";
            }
            else if (enemy.Stage1EnemyType[0] == 8)
            {
                message = "This item is categorized as trash and can’t be recycled";
            }
        ...
        else if (Stage == 2)
        {
            ...
            {
                message = "This item can be composted!";
            }
            else if (enemy.Stage2EnemyType[0] == 2)
            {
                message = "This can be placed in Mixed recycling!";
            }
            else if (enemy.Stage2EnemyType[0] == 3)
            {
                message = "This has to be put in special electronic recycling bins or drop offs!";
            }
            else if (enemy.Stage2EnemyType[0] == 4)
            {
                message = "This should go into paper recycling!";
            }
            else if (enemy.Stage2EnemyType[0] == 5)
            {
                message = "Check with some campus initiatives if they’ll take your item or look for a dropoff point before you try and throw it out.";
            }
            else if (enemy.Stage2EnemyType[0] == 6)
            {
                message = "This object can’t be recycled or reused so it goes in the trash.";
            }
            else if (enemy.Stage2EnemyType[0] == 7)
            {
                message = "You can probably donate this instead of disposing of it!";
            }
            else if (enemy.Stage2EnemyType[0] == 8)
            {
                message = "This object should be cleaned before you get rid of it.";
            }
